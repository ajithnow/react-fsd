...
import type { RouteRecord, ModuleRoutes, CrudRouteNames } from '../models/route.model';
 ...
 */
export function createCrudRoutes(moduleName: string, resourceName?: string): CrudRouteNames {
