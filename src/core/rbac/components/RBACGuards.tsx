// RBAC Guard Components for protecting routes and UI elements

import React from 'react';
import { useRBAC } from '../hooks/useRBAC';
import { PermissionGuardProps } from '../models/rbac.model';
...
/**
 * Guard component that shows children only if user is authenticated
 */
